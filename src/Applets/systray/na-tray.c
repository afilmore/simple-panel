  ...
  if (na_tray_child_has_alpha (NA_TRAY_CHILD (widget)))
    {
      ...
      x = allocation.x - parent_allocation.x;
      y = allocation.y - parent_allocation.y;
      //~ printf ("parent: %d %d %d %d\n", parent_allocation.x, parent_allocation.y, parent_allocation.width, parent_allocation.height);
